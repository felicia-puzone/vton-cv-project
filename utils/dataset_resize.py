...
if __name__ == "__main__":
    ...
    p1 = Process(target=dataset_resize,
                 args=("D:\\Tumor\\DressCode\\dresses", "D:\\Tumor\\DressCodeFinal5.0\\dresses", 0.5), daemon=True)
    p2 = Process(target=dataset_resize,
                 args=("D:\\Tumor\\DressCode\\lower_body", "D:\\Tumor\\DressCodeFinal5.0\\lower_body", 0.5), daemon=True)
    p3 = Process(target=dataset_resize,
                 args=("D:\\Tumor\\DressCode\\upper_body", "D:\\Tumor\\DressCodeFinal5.0\\upper_body", 0.5), daemon=True)
