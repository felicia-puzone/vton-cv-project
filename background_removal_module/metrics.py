...
if __name__ == "__main__":
    ...
    parser.add_argument("-t",help="directory where the ground-truth masks reside",dest="true_dir",required=True,nargs='?')
    parser.add_argument("-p",help="directory where the predicted masks reside",dest="pred_dir",required=True,nargs='?')
    parser.add_argument("-n",help="number of masks loaded at once (not yet implemented)",default=10,dest="batch",nargs='?')
