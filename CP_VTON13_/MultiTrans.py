...
class MULTModel(nn.Module):
    def __init__(self, img_H=512, img_W=384, patch_size = 32, dim = 1024):
        """
        """
        ...
        self.backRearrange = nn.Sequential(Rearrange('b (h w) (p1 p2 c) -> b c (h p1) (w p2)', p1=patch_size, p2=patch_size, h=img_H//patch_size, w= img_W//patch_size))
