...
class CPDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        self.dress_type = opt.dress_type
    ...
    def __getitem__(self, index):
        ...
        if self.stage == 'GMM':
            ...
            parse_head = (parse_array == DressCode_labelmap_g[1]).astype(np.float32) + \
                ...
                (parse_array == DressCode_labelmap_g[17]).astype(np.float32) + \
 ...
 # CV13 fix: added left-shoes and right shoes to reserved regions
        ...
        parse_cloth = (parse_array == DressCode_labelmap_g[5]).astype(np.float32) + \
            (parse_array == DressCode_labelmap_g[6]).astype(np.float32)    # upper-clothes labels
